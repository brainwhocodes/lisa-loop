...
# Create skills directory and skills
mkdir -p .codex/skills
cat > .codex/skills/run-tests << 'EOF'
#!/bin/bash
# Mock run-tests skill
echo "Running tests..."
EOF
chmod +x .codex/skills/run-tests

cat > .codex/skills/lint << 'EOF'
#!/bin/bash
# Mock lint skill
echo "Running lint..."
EOF
chmod +x .codex/skills/lint

cat > .codex/skills/status-summary << 'EOF'
#!/bin/bash
# Mock status-summary skill
echo "Status summary..."
EOF
chmod +x .codex/skills/status-summary
...
@test "full workflow creates complete Ralph project structure" {
    ...
    assert_dir_exists "my-app/.codex"
    ...
    assert_file_exists "my-app/.codex/config"
    assert_file_exists "my-app/.codex/README.md"
